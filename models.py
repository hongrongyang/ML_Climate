...
class ProbEnsemble(nn.Module):
    ...
    def __init__(self, state_size, action_size,network_size=7, elite_size=5, cuda=True, cost=False, binary_cost=False,
                 hidden_size=256, lr=0.001, name='model', chkpt_dir='./data'):
        super().__init__()
        ...
        self.checkpoint_file = os.path.join(self.checkpoint_dir, name + '_AMS')
    ...
    def train(self, inputs, targets, batch_size=128, max_epochs_since_update=5, max_epochs=5):
